...
class GildedRoseTest {
	...
	@CsvSource(value = { "'Aged Brie', 3, 0, 2, 1", "'Aged Brie', 0, 0, -1, 2", "'Aged Brie', 10, 54, 9, 54",
			...
			"'Backstage passes to a TAFKAL80ETC concert', 24, 70, 23, 70", "'Sulfuras, Hand of Ragnaros', 3, 10, 3, 10",
			"'Backstage passes to a TAFKAL80ETC concert', 3, 50, 2, 50", "'Patata', 3, 0, 2, 0", "'Patata', 3, 3, 2, 2",
			"'Patata', -1, 3, -2, 1", "'Patata', -1, 1, -2, 0", "'Conjured Mana Cake', 3, 6, 2, 4",
	...
	void updateQualityTest(String name, int sellIn, int quality, int expectedSellIn, int expectedQuality) {
		...
		app.updateQuality();
		assertAll("Item", () -> assertEquals(expectedQuality, app.items[0].quality),
